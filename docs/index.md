...
Glossaries will automatically get applied for the current pair of source and target languages. You do not have to configure anything; the system automatically checks whether a DeepL glossary exists. If multiple glossaries exist for the same language pair, the first one will be applied.
